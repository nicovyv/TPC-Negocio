...
CuilCuit VARCHAR (50) NULL,
Telefono VARCHAR(20) NULL,
Activo BIT NOT NULL DEFAULT 1
);

CREATE UNIQUE INDEX UX_Proveedores_CuilCuit_NotNull
ON Proveedores (CuilCuit)
WHERE CuilCuit IS NOT NULL;
...
CREATE OR ALTER PROCEDURE sp_ListarProd AS
BEGIN
	SELECT 
	P.ID AS IdProducto, 
	P.CodProd AS Codigo, 
